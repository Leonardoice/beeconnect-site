...
## Notes
- 2026-06-21: Rebuilt the "Proof" section to show our own product demos (BookKit, RepKit) instead of client work (Dr Clutter / Why Pay More) — those were removed because client permission was not in place and the jobs were not complete.
